...
// ReactDOM.render(<Calculator currentValue={store.getState().counter()}
//     addFive={() => store.dispatch(createAddAction(5))}
//     subtractFive={() => store.dispatch(createSubtractAction(5))} />,
//     document.querySelector('main'));

ReactDOM.render(<Calculator store={appStore} />, document.querySelector('main'))
